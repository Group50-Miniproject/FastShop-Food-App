from fastshop import app, api
from flask import render_template, redirect, url_for, flash, request, session, Response
from fastshop.models import Table, User, Item, Order
from fastshop.forms import RegisterForm, LoginForm, OrderIDForm, ReserveForm, AddForm, OrderForm
